  ...
  return (
    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <div>
             <img src='images/pg.jpeg' width={"60%"}></img>
          </div>
          {/* <AdbIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} /> */}
          {/* <Typography
            variant="h6"
          ...
          <Button
                                style={{marginLeft:"7px" , borderRadius:"7px" , color:"black" }}
                                key="Home"
                                color='secondary'
                                variant='contained'
                                sx={{ my: 2, color: 'white', display: 'block' }}
          ...
          <Button
                            ...
                            <Button
                                style={{marginLeft:"7px" , borderRadius:"7px" , color:"black", padding:"6px 16px" }}
                                key="Friends"
                                color='secondary'
                                variant='contained'
                                sx={{ my: 2, color: 'white', display: 'block' }}
