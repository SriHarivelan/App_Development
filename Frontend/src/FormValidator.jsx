...
const Form = () => {
    ...
    return (
        <div className='whole' style={{backgroundColor:"black"}}>
            <div>
                {/* <div className="mob">
                    <p>
                        TOLLFREE NO : +91 6379626366
                    </p>
                </div> */}
                {/* <div>
                ...
                <div className="para1">
                    <p>
                        Welcome to VShare..! Lets Share Our Work..!!
                    </p>
                </div>
                
            </div>
            <div style={{ display: "flex", justifyContent: "center", width: "100%" }}>
                <div style={{ width: "50%", marginTop: "240px", marginLeft: "45px" }}>
                    ...
                    <h1 style={{ color: "white" }}><i>
                        ...
                        <img src='logo-no-background.png' width={600}/>
                </div>
