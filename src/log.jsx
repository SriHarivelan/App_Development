...
const Login = () => {
  ...
  return (
    <div className='hehe'>
   <div style={{backgroundImage:"url(logbg2.jpg)", minHeight:"100vh", margin:"0px",padding:"0px", boxSizing:"border-box",width: "100%", paddingTop:"200px", color:"white",backgroundSize: "cover",backgroundRepeat: "none"}}>
    <div className='bg'>
      <div className='bgclr'>
